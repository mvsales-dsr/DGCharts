...
open class ChartViewBase: UIView, ChartDataProvider, AnimatorDelegate
{
    // MARK: - Properties
    ...
    open var noDataFont = UIFont.systemFont(ofSize: 12)
    
    /// color of the no data text
    open var noDataTextColor: UIColor = .label
    ...
    open func save(to path: String, format: ImageFormat, compressionQuality: Double) -> Bool
    {
        ...
        case .jpeg: imageData = image.jpegData(compressionQuality: CGFloat(compressionQuality))
        }
